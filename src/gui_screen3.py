...
def draw(screen, mouse):
    ...
    menu['btn3'].draw_rect(screen, mouse, (x+110,y+160,height,width), (x+220,y+160))
    menu['btn4'].draw_rect(screen, mouse, (x+220,y+160,height,width), (x+220,y))
